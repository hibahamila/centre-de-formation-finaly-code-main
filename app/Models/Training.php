...
//     Avantages de la méthode boot() :
//        static::deleting(function ($training) {


// ✅ Automatique : Se déclenche automatiquement à chaque suppression de formation
// ✅ Cohérence : Peu importe où/comment la formation est supprimée (interface admin, API, commande artisan, etc.)
// ✅ Sécurité : Impossible d'oublier de nettoyer les réservations
// ✅ Principe de responsabilité : Le modèle Training gère ses propres dépendances
    protected static function boot()
    {
        ...
        static::deleting(function ($training) {
        // Nettoyer automatiquement les réservations
        app(ReservationController::class)->removeTrainingFromReservations($training->id);
    });
    }
