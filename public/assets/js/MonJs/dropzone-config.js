...
//  1 Initialisation de Dropzone : Configuration de Dropzone pour gérer le téléchargement des fichiers.
// 2 Téléchargement des fichiers : Les fichiers sont envoyés au serveur via une requête AJAX vers une route Laravel.
// 3 Affichage des fichiers téléchargés : Les fichiers apparaissent dans l'interface Dropzone avec une icône de suppression.
// 4 Prévisualisation au clic : Lorsqu'un utilisateur clique sur un fichier, son contenu est affiché dans une zone de prévisualisation.
// 5 Gestion des fichiers ZIP : Les fichiers ZIP sont décompressés côté client avec JSZip pour afficher leur arborescence, et les fichiers texte à l'intérieur peuvent être lus.
// 6 Gestion serveur : Le contrôleur Laravel gère le stockage, la récupération et la suppression des fichiers.
...
<div class="preview-header p-4" style="background-color:rgb(41, 41, 42) !important;color:white; position: sticky; top: 0; z-index: 999;">                                            <h5 class="mb-0">Aperçu du PDF : ${file.name}</h5>
                                        </div>
