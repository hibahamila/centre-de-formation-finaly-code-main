...
<div class="modal fade" id="deleteWithConfirmedReservationsModal" tabindex="-1" role="dialog" aria-labelledby="deleteWithConfirmedReservationsModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-white">
                <h5 class="modal-title text-white" id="deleteWithConfirmedReservationsModalLabel">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title text-white" id="deleteWithCombinedReservationsModalLabel">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\Downloads\centre-de-formation-finaly-code-main\centre-de-formation-finaly-code-main\resources\views/admin/apps/formation/formations.blade.php ENDPATH**/ ?>